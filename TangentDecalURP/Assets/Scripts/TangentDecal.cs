            ...
            foreach (var drawcall in drawcalls)
            {
                ...
                foreach (var renderer in query.renderers)
                {
                    for (var i = 0; i < renderer.sharedMaterials.Length; i++)
                    {
                        ...
                        {
                            cmd.DrawRenderer(renderer, material, i, drawcall.pass);
                        }
                    }
                }
            }
